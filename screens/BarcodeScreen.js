    ...
    return (
      <View style={styles.container}>
        <Text style={{ margin: 10 }}>
          Sem acesso a camera garantido, por favor aceder as configurações do
          dispositivo e garantir acesso da camera a aplicação
        </Text>
      </View>
    );
  }
    ...
    <View style={styles.page}>
      <View style={styles.searchBar}>
        <View style={styles.logoContainer}>
          <Image
            source={require("../assets/logo_correto.png")}
            style={styles.logo}
          ></Image>
        </View>
